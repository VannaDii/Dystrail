...
mod tests {
    ...
    const JOURNEY_LEDGER_DIGEST: [u8; 32] = [
        104, 146, 234, 98, 82, 201, 27, 63, 61, 48, 233, 131, 245, 17, 10, 231, 19, 172, 56, 189,
        250, 17, 23, 141, 245, 112, 120, 78, 194, 139, 205, 13,
    ];
    const CSV_DIGEST_BASELINE: [u8; 32] = [
        135, 49, 155, 65, 201, 224, 254, 226, 87, 83, 216, 116, 160, 8, 142, 183, 191, 218, 159,
        38, 221, 248, 45, 170, 227, 164, 208, 57, 143, 24, 220, 59,
    ];
