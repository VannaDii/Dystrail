...
pub const WORD_LIST: [&str; 258] = [
    ...
    "FAUCI", "FEST", "FETTER", "FIRENFY", "FLYNN", "FOXNEWS", "FRAUD", "GAB", "GAETZ", "GATOR",
    "GASLIT", "GETTR", "GIULIA", "GORKA", "GORSUCH", "GRAHAM", "GREENE", "GRIFTER", "GUILFOY",
    "GULFOFA", "GUTFELD", "GUVMENT", "HAMBERD", "HANNITY", "HAWLEY", "HERSHEL", "HICKS", "HOAX",
    "HOAXER", "HOCKER", "HUNTER", "HYDROXY", "ICE", "IMPEACH", "INFRAWK", "INGRAHM", "INSURCT",
    "IVANA", "IVANKA", "JANUARY", "JERKS", "JORDAN", "KAG", "KAVANAH", "KELLY", "KELLYAN",
    "KRAKEN", "KRISTI", "KUNGFLU", "KUSHJR", "KUSHNR", "LARA", "LAWLESS", "LEVIN", "LIMBAUG",
    "LINWOOD", "LIZ", "LOCKDOW", "LOCKDWN", "LOCKHER", "LOSER", "LOSERS", "LOYALTY", "MAGA",
    ...
    "ROSS", "RUDY", "RUMBLE", "RUSSIA", "RYAN", "SAD", "SARAH", "SAVIOR", "SCALISE", "SCHUMER",
    "SCOTT", "SESSNS", "SHAM", "SHARPIE", "SIDNEY", "SPACEF", "SPACEX", "SPICER", "SPYGATE",
    "STEVE", "STONE", "STOPCNT", "SUCKERS", "SUNUNU", "SYMPOS", "TAPPER", "TAXES", "THOMAS",
    "TIFFANY", "TIKTOK", "TILLER", "TLAIB", "TRADEWR", "TRAVELB", "TRUMP", "TRUTHSO", "TWEETS",
    "UKRCALL", "ULTRAMG", "UNMASK", "VACCINE", "VOTEFRA", "WALKER", "WALL", "WARNOCK", "WARPSPD",
    "WHITAKR", "WIN", "WITCH", "YOUREFI", "YUGE", "ZEROTOL", "ZINKE",
];
