...
pub fn journey_scene(p: &Props) -> Html {
    ...
    let indoors =
        name.is_some_and(|n| matches!(n, "enc-media-workshop" | "enc-civic" | "enc-radio"));
