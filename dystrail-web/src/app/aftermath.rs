...
pub struct Aftermath {
    ...
    #[serde(default)]
    pub resources: Vec<crate::game::journal::ResourceChange>,
}
...
mod tests {
    ...
    #[test]
    fn reports_actual_capped_changes() {
        let before = Stats {
            supplies: 19,
            ..Stats::default()
        };
        ...
        assert_eq!(feedback.changes(), vec![("ux.supplies", 1, false)]);
    }
}
