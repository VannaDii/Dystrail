...
root = Path('/tmp/dystrail-share-card-hud-release')
payload = root/'release-site'
baseline = json.loads(Path('/tmp/dystrail-share-hud-review/release-prep/baseline-release-manifest.json').read_text())
