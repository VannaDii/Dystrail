...
const out='/tmp/dystrail-native-share-focus/update-check';await mkdir(out,{recursive:true});
const prior='33dd2b05a6658d330912',expected='d3ed78dac458b64a80ee';
let root='/tmp/dystrail-share-hud-review/verified-web';
...
try{
 ...
 await context.close();root='/tmp/dystrail-native-share-focus/web';
