...
const manifest=JSON.parse(await readFile('/tmp/dystrail-hourly-balance-release/release-site/play/offline-manifest.json','utf8'));
...
const errors=[];
const report={revision:expected,network:'offline before initial navigation',profile:out+'/recheck-old-production-profile',errors};
