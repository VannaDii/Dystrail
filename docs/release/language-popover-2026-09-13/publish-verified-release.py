...
out = Path('/tmp/dystrail-language-popover-20260913/release-prep')
...
assert latest == [{'conclusion':'success','headSha':'5722f8b0b36b27c815902359a54a08e77e7c6589','status':'completed'}], 'Production baseline changed before dispatch'
