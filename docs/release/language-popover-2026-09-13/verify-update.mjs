...
const prior='d75df50dab2d09572dcf';
let root='/tmp/dystrail-chevron-release/release-site/play';
...
try{
 ...
 assert.deepEqual(normalize(after),normalize(expectedSave),'The complete player save must remain intact through the menu-only release');report.updatePreservedSave=true;
