...
manifest=json.loads(Path('/tmp/dystrail-source-handoff-publication/release-manifest.json').read_text())
...
while time.monotonic()<deadline:
    ...
    if worker['sha256']==manifest['files']['play/sw.js']:
        _,homepage=fetch(base+'index.html')
        _,index=fetch(base+'play/index.html')
        _,offline=fetch(base+'play/offline-manifest.json')
        if homepage['sha256']==manifest['files']['index.html'] and index['sha256']==manifest['files']['play/index.html'] and offline['sha256']==manifest['files']['play/offline-manifest.json']:
            break
    time.sleep(5)
...
canonical_expected=[
    ...
    ('https://dystrail.com/play','https://dystrail.com/play/','play/index.html'),
    ('https://dystrail.com/play?review=entry%20route','https://dystrail.com/play/?review=entry%20route','play/index.html'),
